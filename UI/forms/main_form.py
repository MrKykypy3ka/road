...
class Ui_mainForm(object):  # Класс главного окна приложения
    def setupUi(self, Dialog):  # Описание всех виджетов находящихся на окне
        ...
        self.pushButton.setGeometry(QtCore.QRect(1210, 650, 60, 60))
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(112, 480, 61, 61))
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(225, 170, 61, 61))
